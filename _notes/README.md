# Chat Room API Frontend Project
...
This is the frontend interview project for *! We're going to ask you to build something with whatever tools you want, whatever language you want, or whatever.
