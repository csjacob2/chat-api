...
## Set Username
The first screen you should see is the "login" screen. A user can type a username they'll use, and if they provide some string and hit "Join the Chat!" button, we'll save their username for when they add new messages.
